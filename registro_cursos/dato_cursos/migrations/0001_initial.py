# Generated by Django 4.0.3 on 2022-04-06 00:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estudiante', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='dato_cursos.estudiante')),
            ],
        ),
        migrations.CreateModel(
            name='Curso',
            fields=[
                ...
                ('profesores', models.ManyToManyField(related_name='cursos', to='dato_cursos.profesor')),
            ],
        ),
    ]
